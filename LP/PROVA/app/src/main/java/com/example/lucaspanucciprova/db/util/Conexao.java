package com.example.lucaspanucciprova.db.util;
...
import com.example.lucaspanucciprova.db.DBTarefas;

public class Conexao {

    private SQLiteDatabase database ;
    private DBTarefas sqliteOpenHelper ;

    public Conexao(Context context )
    {
        sqliteOpenHelper = new DBTarefas(context) ;
    }
