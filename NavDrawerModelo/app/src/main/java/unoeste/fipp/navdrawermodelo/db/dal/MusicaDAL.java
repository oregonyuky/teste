...
{   private Conexao con;
    ...
    public boolean salvar(Musica o)
    {
        ...
        dados.put("mus_interprete",o.getAutor());
    ...
    public ArrayList<Musica> buscarPorTituloOuInterprete(String termo) {
        String textoSeguro = termo.replace("'", "''");
        return get("mus_titulo LIKE '%" + textoSeguro + "%' OR mus_interprete LIKE '%" + textoSeguro + "%' ");
    }
}
